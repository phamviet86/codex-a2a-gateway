"""Authenticated HTTP/SSE broker. Run with ``python -m codex_a2a_gateway.broker``."""
...
def run_broker() -> None:
    try:
        ...
        raise SystemExit(
            "Invalid broker configuration; check CODEX_A2A_GATEWAY_BROKER_* environment variables"
        ) from None
    uvicorn.run(
