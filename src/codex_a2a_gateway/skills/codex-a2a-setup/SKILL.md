...
If the selected topology is the v0.6 Desktop client plus remote broker, follow
[client/server setup](references/client-server.md) first. It uses a separate
daemon, PostgreSQL and authenticated HTTPS; the numbered local-mode procedure
below does not configure that profile. Preserve a settled topology choice.
