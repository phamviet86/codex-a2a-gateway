"""Separate v0.6 MCP facade. Native identity is host metadata, never tool input.
...
async def gateway_submit(
    ...
    wait_seconds: Annotated[float | None, Field(ge=0, le=60)] = None,
) -> ToolResult:
